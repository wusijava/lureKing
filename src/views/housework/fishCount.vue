<template>
    <div class="box">
        <van-notice-bar
                left-icon="volume-o"
                text="将本人所有鱼获按鱼种分类进行统计条数，默认采用从数量大到小顺序展示！！！"
        />
        ...
        <div class="content">
            ...
            <div class="list" v-for="item in list" :key="item.id" >
                <van-cell-group >
                    <van-cell title="鱼种" :value="item.fishName" />
...
<script>
    import {fishCount,receiveWork} from "../../api/order";
    import Vue from 'vue';
    ...
    export default {
        ...
        methods: {
            ...
            getList: async function(cp,c) {
                ...
                const result = await fishCount(params);
                this.$toast.clear();
