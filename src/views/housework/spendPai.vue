<template>
    <div class="box">
        <van-notice-bar
                left-icon="volume-o"
                text="把有路亚花费数据的大师进行统计排名，再除以鱼获数量，算下每条鱼值多少钱！"
        />
        ...
        <div class="content">
            ...
            <div class="list" v-for="item in list" :key="item.id" >
                <van-cell-group >
                    ...
                    <van-cell title="共计花费 " :value="item.spend" />
                    <van-cell title="鱼获条数 " :value="item.num" />
                    <van-cell title="鱼单价 " :value="item.price" />
                </van-cell-group>
                </div>
...
<script>
    import {spendPai,receiveWork} from "../../api/order";
    import Vue from 'vue';
    ...
    export default {
        ...
        methods: {
            ...
            getList: async function(cp,c) {
                let params = {};
                params.type= 'year'
                const result = await spendPai(params);
                this.$toast.clear();
