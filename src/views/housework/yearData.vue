<template>
    <div class="box">
        <van-notice-bar
                left-icon="volume-o"
                text="鱼获数据分析:按年度统计出勤次数，鱼获数量，打龟次数，中鱼天数,打龟率,放流数据，最大中鱼天数间隔等"
        />
        ...
        <div class="content">
            ...
            <div class="list" v-for="item in list" :key="item.id" >
                <van-cell-group >
                    <van-cell title="年份" :value="item.month" />
                    <van-cell title="出勤次数" :value="item.num" />
...
<script>
    import {yearData,receiveWork} from "../../api/order";
    import Vue from 'vue';
    ...
    export default {
        ...
        methods: {
            ...
            getList: async function(cp,c) {
                ...
                const result = await yearData(params);
                this.$toast.clear();
