<template>
    <div class="box" v-if="showForm===true">
        <van-notice-bar
                left-icon="volume-o"
                text="记录平时作钓标点，枯水期记录水下结构，为汛期作钓提供参考！共同建立数据，资源共享！"
        />
        <van-cell-group>
         <h5>还在开发中，我想去路亚，我不想写代码！</h5>
            <h5>还在开发中，我想去路亚，谁来帮我写代码！</h5>
            <h5>还在开发中，我想去路亚，谁来帮我写代码！</h5>
            <h5>还在开发中，我想去路亚，谁来帮我写代码！</h5>
            <h5>还在开发中，我想去路亚，谁来帮我写代码！</h5>
            <h5>还在开发中，我想去路亚，谁来帮我写代码！</h5>
        ...
        <van-cell style="color: #cf2d28;margin-top: 50px"> {{this.province}}</van-cell>

        <div class="box2" style="margin: 15px">
            <van-button class="button" @click="submit" type="info" size="large" :loading="loading">确定新增标点</van-button>
        </div>
    </div>
