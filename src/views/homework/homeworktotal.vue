    ...
    <div class="box">
        ...
        <div class="content">
            <div class="list" v-for="item in list" :key="item.id" >
                <van-cell-group :title="item.time">
                    <van-cell title="总任务数" :value="item.task" />
                    <van-cell title="已做" :value="item.yiDo" />
                    <van-cell title="未做" :value="item.weiDo" v-if="item.weiDo==0"/>
                    <van-cell title="未做" :value="item.weiDo" style="color: red" v-if="item.weiDo!=0"/>
                    <van-cell title="正确" :value="item.right" />
                    <van-cell title="错误" :value="item.error" />
                    <van-cell title="正确率" :value="item.rate" />
...
<script>
    import {homeworkTotal,changeState} from "../../api/order";
    import Vue from 'vue';
    ...
    export default {
        ...
        methods: {
            ...
            getList: async function(cp,c) {
                ...
                const result = await homeworkTotal(params);
                console.log(result)
                this.$toast.clear();
