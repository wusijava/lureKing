        ...
        <div class="content">
            ...
            <div class="list" v-for="item in list" :key="item.id">
                <van-swipe-cell :before-close="beforeClose">
                    <van-cell-group >
                        <van-cell title="鱼种：" :value="item.fishKind" />
                        <van-cell title="重量：" :value="item.weight" />
                        <van-cell title="长度：" :value="item.length" />
                        ...
                        <van-cell title="星期：" :value="item.week" />
                        <van-cell title="水位：" :value="item.waterLevel" />
                        <van-cell title="放流/放油：" :value="item.use" />
...
<script>
    ...
    import {taoList,taoDetail,deleteFish} from "../../api/order";
